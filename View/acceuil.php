<div id="slide1">
    ...
    <div class="intro">
        Ce site a pour vocation de réunir une communauté française autour des jeux de survie que nous aimons tant.<br>
...
<div id="slide2">
    <div class="slide_inside">
        <div class="presentation">
            ...
            <div class="art1">
                <span>
                    Survivantes,Survivants toi qui est fan de jeux de survie, de build, de dépassement de soi tu es ici au bon endroit<br><br>
                    La communauté Mundus Sine Nominé autrefois appelée les survivants <br>
                    s'est vue renaitre sous le nom de Mundus Sine Nominé (Le monde sans nom) <br><br>
                    Le staff se compose d'une dizaine de personnes bénévoles et chacun y trouve son rôle <br>
                    ...
                    ( qui aujourd'hui depasse la barre des 1200) Mundus propose plusieurs serveurs ouverts gratuitement à nos membres <br>
                    et la possibilité de louer un espace pour ceux qui voudraient une partie avec des règles plus personelles<br>
                    ( ajout de mods, partie en commité restreint, test de certains jeux etc...).<br><br>
                    Nous esperons que vous prendrez plaisir à jouer sur nos serveurs<br>
                    survivalement vôtre !!<br><br>Mundus
                </span>
            </div>
        </div>
    </div>

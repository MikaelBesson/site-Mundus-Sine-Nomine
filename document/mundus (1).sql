...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 25 mai 2021 à 13:44
...
--
ALTER TABLE `game`
  ADD CONSTRAINT `info` FOREIGN KEY (`infogame_fk`) REFERENCES `infogame` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
